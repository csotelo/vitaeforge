...
#show: rendercv.with(
  ...
  colors-body: rgb(60, 60, 60),
  colors-name: rgb(30, 30, 30),
  colors-headline: rgb(198, 138, 42),
  colors-connections: rgb(70, 70, 70),
  colors-section-titles: rgb(198, 138, 42),
  colors-links: rgb(90, 90, 100),
  ...
  entries-highlights-bullet: "{{ design.entries.highlights.bullet }}",
  entries-highlights-nested-bullet: "{{ design.entries.highlights.nested_bullet }}",
